...
print("\nEthereum Fraud Detection - KNN + Feature Selection")
print(f"\nNumber of selected features: {len(selected_feature_names)}")
print("Selected features:")
print(selected_feature_names.tolist())

# Scale AFTER feature selection for KNN
...
plt.title("Ethereum Fraud Detection - KNN + Feature Selection")
plt.tight_layout()
plt.savefig(
    os.path.join(BASE_DIR, "..", "..", "..", "figures", "Ethereum", "ethereum_knn_fs_confusion_matrix.png"),
    dpi=300,
    bbox_inches="tight"
)
plt.show()