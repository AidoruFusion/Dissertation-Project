"""
phishing_lr_adv_model.py
------------------------
Adversarial evaluation and hardening of Logistic Regression on the UCI
Phishing Websites dataset.

Run:
    python phishing_lr_adv_model.py
"""
...
FIG_DIR = os.path.join(BASE_DIR, "..", "..", "..", "figures", "Phishing")
...
MODEL_NAME = "lr"
PRETTY_DS = "Phishing"
PRETTY_MDL = "Logistic Regression"
...
def main():
    ...
    baseline = LogisticRegression(**LR_PARAMS)
    ...
    print(f"\n[adv] retraining hardened Logistic Regression on {X_aug.shape[0]} samples ...")
