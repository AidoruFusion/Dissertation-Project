"""
phishing_mlp_adv_model.py
-------------------------
Adversarial training of the lightweight MLP on the UCI Phishing Websites
dataset using transfer-PGD attacks. Mirrors phishing_mlp_model.py for
the baseline.

Run:
    python phishing_mlp_adv_model.py
"""
