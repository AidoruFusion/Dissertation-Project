"""
phishing_knn_adv_model.py
-------------------------
Adversarial evaluation and hardening of KNN on the UCI Phishing Websites dataset.

Run:
    python phishing_knn_adv_model.py
"""
...
def main():
    ...
    baseline = KNeighborsClassifier(**KNN_PARAMS)
    ...
    print(f"\n[adv] retraining hardened KNN on {X_aug.shape[0]} samples ...")
